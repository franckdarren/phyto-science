        ...
        <>
            ...
            <div className="bg-white flex flex-col justify-center py-[40px] mx-[8%] relative top-[-50px] rounded-[15px] shadow-xl">
                ...
                <p className="font-regular text-[15.5px] leading-[23.3px] text-center px-[40px] mb-[30px]">
                    Explorez notre science innovante des cellules souches
                    végétales pour traiter les pathologies lourdes et bien plus
                    encore.
                </p>
                ...
                <div className="flex flex-col justify-center gap-[50px] md:grid md:grid-cols-3 md:gap-[10px]">
                    ...
                    <div className="w-[95%] md:w-[100%] mx-auto bg-white rounded-lg shadow-xl">
                        ...
                        <div className="my-[20px] px-[40px] md:px-[10px]">
                            ...
                            <p className="font-regular text-[15.5px] text-center leading-[24px] pb-[10px]">
                                Recherche continue pour offrir les meilleurs
            ...
            <div className="bg-[#F3F7EC]">
                ...
                <p className="text-black text-center font-regular text-[17px] px-[10%] pt-[5px] pb-[50px]">
                    Nous sommes situé aux tours Santullo derrière le Ministère
                    des Eaux et Forêt
                </p>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="pb-[50px]">
                    ...
                    <Image
                        src={certificat}
                        alt="Certificat"
                        className="object-cover h-[108px] w-[156px] mx-auto"
                    />
                </div>
            </div>
        </>
