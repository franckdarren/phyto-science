...
const ShareButtons = ({ url, title }) => {
    ...
    return (
        <div className="flex gap-4 px-4 mb-5">
            ...
            <a href={whatsappShare} target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white p-2 rounded flex items-center gap-1 transition-transform duration-300 ease-in-out transform hover:scale-110 text-[15px]">
