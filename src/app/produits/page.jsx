...
export default function Produits() {
    const data = [
        ...
        },
        {
            ...
            imageHover: "/assets/tri.png",
            description:
                "<ul><li>- Réduire les tâches</li><li>- Réduire les rides</li><li>- Meilleure texture des compétences et teint</li><li>- Peau humide et souple</li><li>- Vitalité de peau améliorée</li></ul>",
        },
        {
            id: 9,
            nom: "H2O Stemcell",
            image: "/assets/h20.png",
            imageHover: "/assets/tri1.png",
            description:
